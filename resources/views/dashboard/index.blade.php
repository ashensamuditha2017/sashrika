@extends('layouts.dashboard', ['elementActive' => 'dashboard'])
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Production (Monthly)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">200Mn Nuts</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Production (Annual)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">3420Mn Nuts</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pest Outbreak
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
